...
public class Notebook extends Product {
	...
	public Notebook(int id, double price, double discountRate, int amount, String name, String brand, int memory,
	...
	public static void print(List<Notebook> notebooks) {
		System.out.println(
				"| ID | Name of Product               | Price     | Brand     | Memory  | Screen Size | RAM      |");
		System.out.println(
				"-------------------------------------------------------------------------------------------------");
		for (Notebook notebook : notebooks) {
			System.out.printf("| %-2d | %-29s | %-9.1f | %-9s | %-7d | %-11.1f | %-8d |", notebook.getId(),
					notebook.getName(), notebook.getPrice(), notebook.getBrand(), notebook.getMemory(),
